...
var debug = require('debug')('pachong : update : read');
...
exports.classList = function(url,callback){
	...
	request(url,function(err,res){
		...
		$('.classList li a').each(function(){
			...
			//从URL中提取出分类ID    \articlelist_1776757314_0_1.html
...
exports.articleList = function(url,callback){
	...
	request(url,function(err,res){
		...
		$('.articleList .articleCell').each(function(){
			...
			//从URL中提取出分类ID   "http://blog.sina.com.cn/s/blog_69e72a420101gvec.html"
